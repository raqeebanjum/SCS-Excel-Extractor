...
output_file = "ComparedOutput.xlsx"
...
# === Load Excel files ===
mistral_raw = pd.read_excel("MistralOutput.xlsx", dtype=str).fillna("")
deepseek_raw = pd.read_excel("DeepSeekOutput.xlsx", dtype=str).fillna("")
...
# === Save final Excel ===
wb.save(output_file)
print(f"✅ Done. Normalized comparison saved to {output_file}")